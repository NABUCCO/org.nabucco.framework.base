...
public abstract class AspectSupport {
     ...
     */
    protected Code findCode(String codePath, String name) throws ResolveException {
        return this.findCode(new CodePath(codePath), name);
    }
     ...
     *             when an error occurs
     */
    protected Code findCode(CodePath codePath, String name) throws ResolveException {
        ...
        try {
            ...
            ServiceRequest<DynamicCodePathRq> rq = new ServiceRequest<DynamicCodePathRq>(this.context);
