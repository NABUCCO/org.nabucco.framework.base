...
final class DatatypeConnectorVisitor extends ServiceMessageVisitor {
     ...
     */
    private void connect(DatatypeConnector connector, NabuccoDatatype datatype)
            throws VisitorException {
        ...
        try {
            ...
            throw new VisitorException("Error connecting datatype '"
                    + connector.getSourceDatatypeClass() + "'.", ce);
        }
    }
