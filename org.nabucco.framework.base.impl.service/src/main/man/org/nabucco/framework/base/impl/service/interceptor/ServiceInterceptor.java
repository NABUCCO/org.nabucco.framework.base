...
import org.nabucco.framework.base.impl.service.interceptor.strategy.InterceptorStrategy;
import org.nabucco.framework.base.impl.service.interceptor.strategy.InterceptorStrategyDelegate;
...
public class ServiceInterceptor {
    ...
    private InterceptorStrategy strategy = new InterceptorStrategyDelegate();

    public Object service(InvocationContext ctx) throws Exception {
        ...
        try {
            ...
            if (logger != null) {
                logger.debug(t, invocationIdentifier, " Throwable during service call of method: ",
                        ctx.getMethod().getName());
            }

            exception = t;
            throw new NabuccoException(t.getMessage(), t);
