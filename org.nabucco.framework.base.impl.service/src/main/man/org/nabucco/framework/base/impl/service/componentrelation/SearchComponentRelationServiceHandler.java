 ...
 */
public abstract class SearchComponentRelationServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<ComponentRelationListMsg> invoke(ServiceRequest<ComponentRelationSearchRq> rq)
            throws SearchException {
     ...
     * @throws SearchException
     */
    protected abstract ComponentRelationListMsg searchComponentRelation(ComponentRelationSearchRq msg)
            throws SearchException;
