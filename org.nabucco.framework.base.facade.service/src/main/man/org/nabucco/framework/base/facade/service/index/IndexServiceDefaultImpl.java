...
public class IndexServiceDefaultImpl implements IndexService {
    ...
    private static final String SERVICE_NAME = "org.nabucco.framework.base.facade.service.index.IndexService";
    ...
    public ServiceResponse<EmptyServiceMessage> resolveExtension(ServiceRequest<IndexRequestMsg> rq)
        ...
        ServiceResponse<EmptyServiceMessage> result = new ServiceResponse<EmptyServiceMessage>(context);
