 ...
 */
package org.nabucco.framework.base.ui.web.model.control.relation;
...
import org.nabucco.framework.base.ui.web.model.control.relation.picker.delegates.CollectionRelationDelegate;
import org.nabucco.framework.base.ui.web.model.control.relation.picker.delegates.ComponentRelationDelegate;
import org.nabucco.framework.base.ui.web.model.control.relation.picker.delegates.DatatypeRelationDelegate;
...
public abstract class RelationControlModel<N extends NType> extends ControlModel<N> {
     ...
     */
    public RelationControlModel(String id, ControlType type, String propertyPath, TableModel<Datatype> tableModel,
            String displayPath, DependencyController dependencyController, boolean editable) {
        super(id, propertyPath, type, null, dependencyController, editable);

        if (tableModel == null) {
            throw new IllegalArgumentException("Cannot create picker control model for provider 'null'.");
        }
