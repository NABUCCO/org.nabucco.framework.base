 ...
 */
package org.nabucco.framework.base.ui.web.servlet.application;
...
/**
 * Servlet for initializing the NABUCCO Web Application.
 * 
 * @author Frank Ratschinski, PRODYNA AG
 * @author Nicolas Moser, PRODYNA AG
 */
public class ApplicationServlet extends NabuccoServlet {

    private static final long serialVersionUID = 1L;

    private static NabuccoLogger logger = NabuccoLoggingFactory.getInstance().getLogger(ApplicationServlet.class);
    ...
    protected void restGet(NabuccoServletRequest request, NabuccoServletResponse response) throws ClientException {
        ...
        try {
            ...
            WebApplication application = session.getWebApplication();
            response.sendResponseParameter(application.toJson());
        } catch (Exception e) {
            logger.fatal(e, "Cannot initialize NABUCCO WebApplication");
        }
    }
