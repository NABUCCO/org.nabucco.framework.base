...
/**
 * Action handler responsible for opening editor tabs.
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class OpenEditorTabHandler extends WebActionHandler {
    ...
    public WebActionResult execute(WebActionParameter parameter) throws ActionException {
        ...
        EditArea editArea = NabuccoServletUtil.getEditArea(editorId);
