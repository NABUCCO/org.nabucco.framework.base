 ...
 */
package org.nabucco.framework.base.ui.web.model.editor.control.property.image;
...
public class SingleImageControlModel extends PropertyControlModel<NType> {
    ...
    private String getImageURL() {
        ...
        if (contentRelation == null) {
            throw new IllegalStateException("The component relation is null. Cannot render single image element");
        }
        ...
        if (instance.size() == 1) {
            ...
            String imageReferenceKey = NabuccoServletUtil.getResourceController().addDownloadReferenceResource(
                    resourceId, type);

            return IMAGE_PREFIX + imageReferenceKey + "/" + target.getName().getValue();
        }
