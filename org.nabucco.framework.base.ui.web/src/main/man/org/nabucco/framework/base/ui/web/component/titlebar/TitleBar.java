 ...
 */
package org.nabucco.framework.base.ui.web.component.titlebar;
...
/**
 * The titlebar holds application and user specific information.
 * 
 * @author Frank Ratschinski, PRODYNA AG
 * @author Nicolas Moser, PRODYNA AG
 */
public class TitleBar extends WebComposite {
    ...
    /** The TitleBar Extension.. */
    private TitleBarExtension extension;

    /**
     * Creates a new {@link TitleBar} instance.
     * 
     * @param extension
     *            the titlebar extension
     */
    public TitleBar(TitleBarExtension extension) {
        super(WebElementType.TITLEBAR, extension);
        if (extension == null) {
    ...
    public void init() throws ExtensionException {
        ...
        for (GridWidgetExtension gridExtension : this.extension.getGrids()) {
            ...
            GridWidgetElement titleBarPart = new GridWidgetElement(gridExtension);
            titleBarPart.init();
            this.addElement(gridId, titleBarPart);
        }
    }
