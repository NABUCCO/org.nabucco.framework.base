...
/**
 * The default NABUCCO Browser implementation.
 * 
...
public class DefaultBrowser extends Browser {
    ...
    /**
     * Creates a new {@link DefaultBrowser} instance.
     * 
     * @param extension
     *            the browser extension
     */
    public DefaultBrowser(BrowserExtension extension) {
        super(extension);
    }
    ...
    public void init() throws ExtensionException {
        ...
        super.setModel(new BrowserModel());
    }
