...
import org.nabucco.framework.base.ui.web.model.widget.text.TextWidgetModel;
 ...
 */
public class TextWidget extends WidgetElement {
     ...
     * @param type
     */
    public TextWidget(TextWidgetExtension widgetExtension) {
    ...
    public void init() throws ExtensionException {
        ...
        TextWidgetModel model = new TextWidgetModel(text, link);
     ...
     */
    public TextWidgetExtension getWidgetExtension() {
        return (TextWidgetExtension) super.getExtension();
    }
