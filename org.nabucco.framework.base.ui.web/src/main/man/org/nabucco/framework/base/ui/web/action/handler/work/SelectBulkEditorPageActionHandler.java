 ...
 */
public class SelectBulkEditorPageActionHandler extends WebActionHandlerSupport {

    public final static String ID = "System.SelectBulkEditorPage";
    ...
    public WebActionResult execute(WebActionParameter parameter) throws ClientException {
        ...
        for (Datatype datatype : currentPage) {
            ...
            editor.getModel().selectRow(String.valueOf(ndatatype.getId()));
        }
