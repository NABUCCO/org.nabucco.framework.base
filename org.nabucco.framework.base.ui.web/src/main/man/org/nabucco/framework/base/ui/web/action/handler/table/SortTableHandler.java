...
/**
 * Sort the table page for the given criteria.
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class SortTableHandler extends WebActionHandler {
    ...
    public WebActionResult execute(WebActionParameter parameter) throws ActionException {
        ...
        String columnId = parameter.get(NabuccoServletPathType.TABLE);
        ...
        if (element != null && element.getType() != null) {
            ...
            tableElement.getTableModel().sort(columnId);
