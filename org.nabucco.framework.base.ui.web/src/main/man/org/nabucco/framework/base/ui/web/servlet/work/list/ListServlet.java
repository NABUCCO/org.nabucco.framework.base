 ...
 */
package org.nabucco.framework.base.ui.web.servlet.work.list;
...
/**
 * Servlet for handling the initialization, data population and action execution of List intances.
 * 
 * @author Frank Ratschinski, PRODYNA AG
 * @author Nicolas Moser, PRODYNA AG
 */
public class ListServlet extends NabuccoServlet {
    ...
    protected void restGet(NabuccoServletRequest request, NabuccoServletResponse response) throws ClientException {
        ...
        String listId = request.getServletPath().getId(NabuccoServletPathType.LIST);
        WorkItem item = NabuccoServletUtil.getWorkItem(listId);

        if (item instanceof ListItem) {
            ListItem list = (ListItem) item;

            list.getTableModel().init();
