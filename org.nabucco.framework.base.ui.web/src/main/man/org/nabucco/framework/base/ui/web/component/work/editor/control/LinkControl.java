...
import org.nabucco.framework.base.ui.web.model.control.property.action.LinkControlModel;
 ...
 */
public class LinkControl extends EditorControl {
     ...
     * @param extension
     */
    public LinkControl(LinkControlExtension extension) {
        super(extension);
    ...
    public String getAction() {
        return PropertyLoader.loadProperty(((LinkControlExtension) this.getExtension()).getAction());
    }


    @Override
    public ControlModel<?> instantiateModel(String id, String propertyPath) {
        return new LinkControlModel(id, propertyPath, this.getAction(), super.getDependencySet());
    }
}
