...
import org.nabucco.framework.base.ui.web.model.widget.search.SearchWidgetModel;
 ...
 */
public class SearchWidget extends WidgetElement {
     ...
     * 
     * @param widgetExtension
     *            the widget extension configuration
     */
    public SearchWidget(SearchWidgetExtension widgetExtension) {
    ...
    public void init() throws ExtensionException {
        ...
        SearchWidgetModel model = new SearchWidgetModel(action);
     ...
     */
    public SearchWidgetExtension getWidgetExtension() {
        return (SearchWidgetExtension) super.getExtension();
    }
