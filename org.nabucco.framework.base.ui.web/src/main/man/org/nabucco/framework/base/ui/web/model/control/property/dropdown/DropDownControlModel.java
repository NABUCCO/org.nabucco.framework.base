...
/**
 * DrowDownControlModel
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class DropDownControlModel<N extends NType> extends PropertyControlModel<N> {

    private static final String JSON_ITEMS = "items";

    /**
     * Creates a new {@link DropDownControlModel} instance.
     * 
     * @param id
     ...
     *            editable
     */
    public DropDownControlModel(String id, String propertyPath, NabuccoValidator<N> validator,
            DependencyController dependencyController, boolean editable) {
        super(id, propertyPath, ControlType.DROPDOWN, validator, dependencyController, editable);
    ...
    public String getStringValue() {
        return this.getSelectionProvider().getStringValue(this.getProperty(), this.getValue());
    }
    ...
    public JsonMap toJson() {
        ...
        json.add(JSON_VALUE, stringValue);
