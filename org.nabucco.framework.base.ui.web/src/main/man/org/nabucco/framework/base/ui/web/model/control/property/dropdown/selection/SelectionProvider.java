...
public interface SelectionProvider<N extends NType> {
     ...
     */
    List<N> getSelection(NabuccoProperty property);

    /**
     * Returns the List with all possible selections Strings
     * 
     * @param Property
     *            Property to be evaluated
     * 
     * @return List List with Literals, Codes ...
     */
    List<String> getSelectionStrings(NabuccoProperty property);
     ...
     * 
     */
    String getStringValue(NabuccoProperty property, NType item);
}
