...
/**
 * CloseCurrentDialogHandler
 * 
 * Closes the dialog with given id
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class CloseDialogHandler extends WebActionHandlerSupport {

    public static final String ID = "System.CloseDialog";
    ...
    public WebActionResult execute(WebActionParameter parameter) throws ClientException {
        ...
        result.addItem(new CloseItem(WebElementType.DIALOG, dialogId));
