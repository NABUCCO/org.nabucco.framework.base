...
public class HashCodeTest {
    ...
    public void testHashCodeBasetype() {
        ...
        Assert.assertFalse("Hashcode of different objects must be different.", n1.hashCode() == n3
                .hashCode());
    }
    ...
    public void testHashCodeDatatype() {
        ...
        User u3 = new User();
        u3.setUsername("Test");
        Assert.assertFalse("Hashcode of different objects must be different.", u1.hashCode() == u3
                .hashCode());
    }
