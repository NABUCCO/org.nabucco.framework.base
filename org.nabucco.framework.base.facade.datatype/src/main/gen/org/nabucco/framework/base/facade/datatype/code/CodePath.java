...
public class CodePath extends NString implements Basetype {
    ...
    private static final String PROPERTY_CONSTRAINTS = "l1,1024;u0,n;";
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(CodePath.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(CodePath.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(CodePath.class).getAllProperties();
    }
}
