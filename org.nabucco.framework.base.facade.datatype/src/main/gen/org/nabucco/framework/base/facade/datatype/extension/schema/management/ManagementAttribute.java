...
/**
 * ManagementAttribute<p/>Configuration for management attributes.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-06-16
 */
public class ManagementAttribute extends NabuccoExtensionComposite implements Datatype {
    ...
    /** Whether the attribute should be settable or not. */
    private BooleanProperty readOnly;

    /** The description of the management attribute. */
    private StringProperty description;

    /** Constructs a new ManagementAttribute instance. */
     ...
     * CloneObject.
     *
     * @param clone the ManagementAttribute.
     */
    protected void cloneObject(ManagementAttribute clone) {
        ...
        if ((this.getReadOnly() != null)) {
            clone.setReadOnly(this.getReadOnly().cloneObject());
        }
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(READONLY, PropertyDescriptorSupport.createDatatype(READONLY, BooleanProperty.class, 4,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(ManagementAttribute.getPropertyDescriptor(NAME), this.getName(), null));
        properties.add(super.createProperty(ManagementAttribute.getPropertyDescriptor(TYPE), this.getType(), null));
        properties.add(super.createProperty(ManagementAttribute.getPropertyDescriptor(READONLY), this.getReadOnly(),
                null));
        properties.add(super.createProperty(ManagementAttribute.getPropertyDescriptor(DESCRIPTION),
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(NAME) && (property.getType() == StringProperty.class))) {
            ...
            return true;
        } else if ((property.getName().equals(READONLY) && (property.getType() == BooleanProperty.class))) {
            this.setReadOnly(((BooleanProperty) property.getInstance()));
            return true;
    ...
    public boolean equals(Object obj) {
        ...
        final ManagementAttribute other = ((ManagementAttribute) obj);
        if ((this.name == null)) {
            if ((other.name != null))
                return false;
    ...
    @Override
    public ManagementAttribute cloneObject() {
        ManagementAttribute clone = new ManagementAttribute();
     ...
     * Whether the attribute should be settable or not.
     *
     * @param readOnly the BooleanProperty.
     */
    public void setReadOnly(BooleanProperty readOnly) {
     ...
     */
    public BooleanProperty getReadOnly() {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(ManagementAttribute.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ManagementAttribute.class).getAllProperties();
    }
}
