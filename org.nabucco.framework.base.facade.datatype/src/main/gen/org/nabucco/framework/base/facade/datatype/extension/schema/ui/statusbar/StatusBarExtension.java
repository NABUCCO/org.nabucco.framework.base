 ...
 */
package org.nabucco.framework.base.facade.datatype.extension.schema.ui.statusbar;
...
/**
 * StatusBarExtension<p/>NABUCCO User Interface StatusBar extension.<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2011-07-12
 */
public class StatusBarExtension extends UiExtension implements Datatype {
    ...
    /** Constructs a new StatusBarExtension instance. */
     ...
     * CloneObject.
     *
     * @param clone the StatusBarExtension.
     */
    protected void cloneObject(StatusBarExtension clone) {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(StatusBarExtension.getPropertyDescriptor(HEIGHT), this.getHeight(), null));
        properties.add(super.createProperty(StatusBarExtension.getPropertyDescriptor(GRIDS), this.grids, null));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final StatusBarExtension other = ((StatusBarExtension) obj);
        if ((this.height == null)) {
    ...
    @Override
    public StatusBarExtension cloneObject() {
        StatusBarExtension clone = new StatusBarExtension();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(StatusBarExtension.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(StatusBarExtension.class).getAllProperties();
    }
}
