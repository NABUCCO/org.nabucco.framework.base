...
public class Documentation extends NText implements Basetype {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(Documentation.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Documentation.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Documentation.class).getAllProperties();
    }
}
