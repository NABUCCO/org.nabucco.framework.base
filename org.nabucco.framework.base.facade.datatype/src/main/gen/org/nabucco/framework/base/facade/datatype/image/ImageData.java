...
/**
 * ImageData<p/>Serialized representation of an image.<p/>
 *
 * @version 1.0
...
public class ImageData extends NByteArray implements Basetype {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(ImageData.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(ImageData.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ImageData.class).getAllProperties();
    }
}
