...
/**
 * TextWidgetExtension<p/>NABUCCO Text Widget<p/>
 *
 * @version 1.0
 * @author Leonid Agranovskiy, PRODYNA AG, 2011-15-09
 */
public class TextWidgetExtension extends WidgetExtension implements Datatype {
    ...
    /** Constructs a new TextWidgetExtension instance. */
    public TextWidgetExtension() {
        super();
        this.initDefaults();
    }
     ...
     * CloneObject.
     *
     * @param clone the TextWidgetExtension.
     */
    protected void cloneObject(TextWidgetExtension clone) {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(LINK, PropertyDescriptorSupport.createDatatype(LINK, StringProperty.class, 7,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(TextWidgetExtension.getPropertyDescriptor(TEXT), this.getText(), null));
        properties.add(super.createProperty(TextWidgetExtension.getPropertyDescriptor(LINK), this.getLink(), null));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final TextWidgetExtension other = ((TextWidgetExtension) obj);
        if ((this.text == null)) {
            if ((other.text != null))
                return false;
    ...
    @Override
    public TextWidgetExtension cloneObject() {
        TextWidgetExtension clone = new TextWidgetExtension();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(TextWidgetExtension.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(TextWidgetExtension.class).getAllProperties();
    }
}
