...
/**
 * WorkflowTriggerExtension<p/>Extension for configuring a workflow trigger.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-03-15
 */
public class WorkflowTriggerExtension extends NabuccoExtensionComposite implements Datatype {
    ...
    /** The name of the signal (when type = SIGNAL). */
    private WorkflowSignalExtension signal;

    /** The name of the timer (when type = TIMER). */
    private StringProperty timer;

    /** Constructs a new WorkflowTriggerExtension instance. */
    public WorkflowTriggerExtension() {
        super();
        this.initDefaults();
    }
     ...
     * CloneObject.
     *
     * @param clone the WorkflowTriggerExtension.
     */
    protected void cloneObject(WorkflowTriggerExtension clone) {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(SIGNAL, PropertyDescriptorSupport.createDatatype(SIGNAL, WorkflowSignalExtension.class, 6,
                PROPERTY_CONSTRAINTS[4], false, PropertyAssociationType.COMPOSITION));
        propertyMap.put(TIMER, PropertyDescriptorSupport.createDatatype(TIMER, StringProperty.class, 7,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties
                .add(super.createProperty(WorkflowTriggerExtension.getPropertyDescriptor(NAME), this.getName(), null));
        properties.add(super.createProperty(WorkflowTriggerExtension.getPropertyDescriptor(OWNER), this.getOwner(),
                null));
        properties.add(super.createProperty(WorkflowTriggerExtension.getPropertyDescriptor(DESCRIPTION),
                this.getDescription(), null));
        properties
                .add(super.createProperty(WorkflowTriggerExtension.getPropertyDescriptor(TYPE), this.getType(), null));
        properties.add(super.createProperty(WorkflowTriggerExtension.getPropertyDescriptor(SIGNAL), this.getSignal(),
                null));
        properties.add(super.createProperty(WorkflowTriggerExtension.getPropertyDescriptor(TIMER), this.getTimer(),
                null));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(NAME) && (property.getType() == StringProperty.class))) {
            ...
            return true;
        } else if ((property.getName().equals(SIGNAL) && (property.getType() == WorkflowSignalExtension.class))) {
            this.setSignal(((WorkflowSignalExtension) property.getInstance()));
            return true;
        } else if ((property.getName().equals(TIMER) && (property.getType() == StringProperty.class))) {
            this.setTimer(((StringProperty) property.getInstance()));
            return true;
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final WorkflowTriggerExtension other = ((WorkflowTriggerExtension) obj);
        if ((this.name == null)) {
            if ((other.name != null))
                return false;
    ...
    @Override
    public WorkflowTriggerExtension cloneObject() {
        WorkflowTriggerExtension clone = new WorkflowTriggerExtension();
     ...
     * The name of the signal (when type = SIGNAL).
     *
     * @param signal the WorkflowSignalExtension.
     */
    public void setSignal(WorkflowSignalExtension signal) {
        this.signal = signal;
    }
     ...
     * The name of the signal (when type = SIGNAL).
     *
     * @return the WorkflowSignalExtension.
     */
    public WorkflowSignalExtension getSignal() {
        return this.signal;
    }
     ...
     * The name of the timer (when type = TIMER).
     *
     * @param timer the StringProperty.
     */
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(WorkflowTriggerExtension.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(WorkflowTriggerExtension.class).getAllProperties();
    }
}
