...
/**
 * FileAttachment<p/>An FileAttachment<p/>
 *
 * @version 1.0
 * @author Markus Jorroch, PRODYNA AG, 2011-01-04
 */
public class FileAttachment extends NabuccoDatatype implements Datatype {
    ...
    /** Constructs a new FileAttachment instance. */
     ...
     * CloneObject.
     *
     * @param clone the FileAttachment.
     */
    protected void cloneObject(FileAttachment clone) {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(FileAttachment.getPropertyDescriptor(NAME), this.name, null));
        properties.add(super.createProperty(FileAttachment.getPropertyDescriptor(DATA), this.data, null));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final FileAttachment other = ((FileAttachment) obj);
        if ((this.name == null)) {
            if ((other.name != null))
                return false;
    ...
    @Override
    public FileAttachment cloneObject() {
        FileAttachment clone = new FileAttachment();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(FileAttachment.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(FileAttachment.class).getAllProperties();
    }
}
