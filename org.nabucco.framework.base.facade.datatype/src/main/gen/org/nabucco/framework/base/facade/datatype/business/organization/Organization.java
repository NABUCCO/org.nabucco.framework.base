...
public class Organization extends NabuccoDatatype implements Datatype {
    ...
    private static final String[] PROPERTY_CONSTRAINTS = { "l3,12;u0,n;m1,1;", "l0,255;u0,n;m1,1;",
            "l0,4000;u0,n;m0,1;", "l0,4000;u0,n;m0,1;", "m1,1;", "l3,32;u0,n;m0,1;", "l0,n;u0,n;m0,1;", "m0,1;" };
    ...
    private LongDescription additional;
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(ADDITIONAL, PropertyDescriptorSupport.createBasetype(ADDITIONAL, LongDescription.class, 6,
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(OWNER) && (property.getType() == Owner.class))) {
            ...
            return true;
        } else if ((property.getName().equals(ADDITIONAL) && (property.getType() == LongDescription.class))) {
            this.setAdditional(((LongDescription) property.getInstance()));
            return true;
     ...
     * @return the LongDescription.
     */
    public LongDescription getAdditional() {
     ...
     * Additinal Organization Information
     *
     * @param additional the LongDescription.
     */
    public void setAdditional(LongDescription additional) {
    ...
    public void setAdditional(String additional) {
        if ((this.additional == null)) {
            ...
            this.additional = new LongDescription();
        }
