...
/**
 * PhoneNumber<p/>A telephone or mobile phone number<p/>
 *
 * @author Nicolas Moser, PRODYNA AG, 2012-01-12
 */
public class PhoneNumber extends NString implements Basetype {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(PhoneNumber.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }

    @Override
    public PhoneNumber cloneObject() {
        PhoneNumber clone = new PhoneNumber();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(PhoneNumber.class).getProperty(propertyName);
    }
