 ...
 */
public class Training extends NabuccoDatatype implements Datatype {
    ...
    /** The functional Training ID. */
    private FunctionalIdentifier functionalId;

    /** The functional Training type. */
    private Code functionalType;

    protected static final String FUNCTIONALTYPE_CODEPATH = "nabucco.business.training.functionaltype";
     ...
     * CloneObject.
     *
     * @param clone the Training.
     */
    protected void cloneObject(Training clone) {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(Training.getPropertyDescriptor(OWNER), this.owner, null));
        properties.add(super.createProperty(Training.getPropertyDescriptor(NAME), this.name, null));
        properties.add(super.createProperty(Training.getPropertyDescriptor(DESCRIPTION), this.description, null));
        properties.add(super.createProperty(Training.getPropertyDescriptor(STATUSTYPE), this.getStatusType(), null));
        properties.add(super.createProperty(Training.getPropertyDescriptor(FUNCTIONALID), this.functionalId, null));
        properties.add(super.createProperty(Training.getPropertyDescriptor(FUNCTIONALTYPE), this.getFunctionalType(),
                null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Training.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Training.class).getAllProperties();
    }
