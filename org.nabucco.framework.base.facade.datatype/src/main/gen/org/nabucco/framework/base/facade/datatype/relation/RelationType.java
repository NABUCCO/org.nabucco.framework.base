...
public enum RelationType implements Enumeration {
    /** Describes an 'is a' relation */
    IS("IS"),
    /** Describes a 'has a' relation */
    HAS("HS"), ;
     ...
     */
    public static RelationType valueOfId(String literalId) {
        for (RelationType enumeration : RelationType.values()) {
