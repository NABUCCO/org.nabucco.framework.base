...
public class UserId extends NString implements Basetype {
    ...
    private static final String PROPERTY_CONSTRAINTS = "l3,32;u0,n;";
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(UserId.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(UserId.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(UserId.class).getAllProperties();
    }
}
