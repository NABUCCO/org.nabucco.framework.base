...
/**
 * WorkflowStateExtension<p/>Extension for configuring a workflow state.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-03-15
 */
public class WorkflowStateExtension extends NabuccoExtensionComposite implements Datatype {
    ...
    /** Constructs a new WorkflowStateExtension instance. */
    public WorkflowStateExtension() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(WorkflowStateExtension.getPropertyDescriptor(NAME), this.getName(), null));
        properties
                .add(super.createProperty(WorkflowStateExtension.getPropertyDescriptor(OWNER), this.getOwner(), null));
        properties.add(super.createProperty(WorkflowStateExtension.getPropertyDescriptor(DESCRIPTION),
                this.getDescription(), null));
        properties.add(super.createProperty(WorkflowStateExtension.getPropertyDescriptor(TYPE), this.getType(), null));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final WorkflowStateExtension other = ((WorkflowStateExtension) obj);
        if ((this.name == null)) {
            if ((other.name != null))
                return false;
    ...
    @Override
    public WorkflowStateExtension cloneObject() {
        WorkflowStateExtension clone = new WorkflowStateExtension();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(WorkflowStateExtension.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(WorkflowStateExtension.class).getAllProperties();
    }
}
