...
public class Password extends NString implements Basetype {
    ...
    private static final String PROPERTY_CONSTRAINTS = "l3,128;u0,n;";
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(Password.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Password.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Password.class).getAllProperties();
    }
}
