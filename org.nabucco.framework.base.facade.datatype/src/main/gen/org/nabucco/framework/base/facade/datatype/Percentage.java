 ...
 */
public class Percentage extends NDecimal implements Basetype {
     ...
     */
    public Percentage(java.math.BigDecimal value) {
        super(value);
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(Percentage.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Percentage.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Percentage.class).getAllProperties();
    }
}
