...
/**
 * TimeSystemVariable<p/>A system variable value of type time.<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2011-04-07
 */
public class TimeSystemVariable extends SystemVariable implements Datatype {
    ...
    /** Constructs a new TimeSystemVariable instance. */
    public TimeSystemVariable() {
        super();
        this.initDefaults();
    }
     ...
     * CloneObject.
     *
     * @param clone the TimeSystemVariable.
     */
    protected void cloneObject(TimeSystemVariable clone) {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(VALUE, PropertyDescriptorSupport.createBasetype(VALUE, TimeVariableType.class, 2,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(TimeSystemVariable.getPropertyDescriptor(VALUE), this.value, null));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final TimeSystemVariable other = ((TimeSystemVariable) obj);
        if ((this.value == null)) {
            if ((other.value != null))
                return false;
    ...
    @Override
    public TimeSystemVariable cloneObject() {
        TimeSystemVariable clone = new TimeSystemVariable();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(TimeSystemVariable.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(TimeSystemVariable.class).getAllProperties();
    }
}
