...
public class CodeNumber extends NString implements Basetype {
    ...
    private static final String PROPERTY_CONSTRAINTS = "l1,500;u0,n;";
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(CodeNumber.getPropertyDescriptor(PROPERTY_NAME).createProperty(this, this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(CodeNumber.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(CodeNumber.class).getAllProperties();
    }
}
