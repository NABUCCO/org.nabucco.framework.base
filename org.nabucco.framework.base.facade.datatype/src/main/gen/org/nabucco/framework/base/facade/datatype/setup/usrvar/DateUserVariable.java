...
/**
 * DateUserVariable<p/>A user variable value of type date.<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2011-04-07
 */
public class DateUserVariable extends UserVariable implements Datatype {
    ...
    /** Constructs a new DateUserVariable instance. */
    public DateUserVariable() {
        super();
        this.initDefaults();
    }
     ...
     * CloneObject.
     *
     * @param clone the DateUserVariable.
     */
    protected void cloneObject(DateUserVariable clone) {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(VALUE, PropertyDescriptorSupport.createBasetype(VALUE, DateVariableType.class, 1,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(DateUserVariable.getPropertyDescriptor(VALUE), this.value, null));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DateUserVariable other = ((DateUserVariable) obj);
        if ((this.value == null)) {
            if ((other.value != null))
                return false;
    ...
    @Override
    public DateUserVariable cloneObject() {
        DateUserVariable clone = new DateUserVariable();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(DateUserVariable.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(DateUserVariable.class).getAllProperties();
    }
}
