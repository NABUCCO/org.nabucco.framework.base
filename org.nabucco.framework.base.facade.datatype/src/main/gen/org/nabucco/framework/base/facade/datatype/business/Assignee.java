...
/**
 * Assignee<p/>An assigned Person.<p/>
 *
 * @version 1.0
...
public abstract class Assignee extends NabuccoDatatype implements Datatype {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Assignee.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Assignee.class).getAllProperties();
    }
}
