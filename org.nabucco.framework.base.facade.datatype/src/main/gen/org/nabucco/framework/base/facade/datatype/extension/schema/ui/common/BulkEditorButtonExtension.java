...
/**
 * BulkEditorButtonExtension<p/>NABUCCO Bulk Editor button extension<p/>
 *
 * @version 1.0
 * @author Leonid Agranovskiy, PRODYNA AG, 2012-02-02
 */
public class BulkEditorButtonExtension extends ListButtonExtension implements Datatype {
    ...
    /** Constructs a new BulkEditorButtonExtension instance. */
    public BulkEditorButtonExtension() {
        super();
        this.initDefaults();
    }
     ...
     * CloneObject.
     *
     * @param clone the BulkEditorButtonExtension.
     */
    protected void cloneObject(BulkEditorButtonExtension clone) {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(DIRTYSTATENEEDED, PropertyDescriptorSupport.createDatatype(DIRTYSTATENEEDED,
                BooleanProperty.class, 11, PROPERTY_CONSTRAINTS[0], false, PropertyAssociationType.COMPOSITION));
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(BulkEditorButtonExtension.getPropertyDescriptor(DIRTYSTATENEEDED),
    ...
    public boolean equals(Object obj) {
        ...
        final BulkEditorButtonExtension other = ((BulkEditorButtonExtension) obj);
    ...
    @Override
    public BulkEditorButtonExtension cloneObject() {
        BulkEditorButtonExtension clone = new BulkEditorButtonExtension();
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(BulkEditorButtonExtension.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(BulkEditorButtonExtension.class).getAllProperties();
    }
}
