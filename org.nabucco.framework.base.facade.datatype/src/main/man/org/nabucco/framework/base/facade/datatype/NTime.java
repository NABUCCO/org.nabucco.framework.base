 ...
 */
public abstract class NTime extends BasetypeSupport implements Basetype, Comparable<NTime> {
     ...
     */
    public NTime(Date value) {
        super(BasetypeType.TIME);
        this.value = value;
    }
    ...
    public void setValue(Object value) throws IllegalArgumentException {
        if (value != null && !(value instanceof Date)) {
            throw new IllegalArgumentException("Cannot set value '" + value + "' to NTime.");
        }
    ...
    public String getValueAsString() {
        ...
        return NabuccoConverter.getInstance().getDateConverter().convertTime(this.value);
    }

    /**
     * Returns a <code>String</code> object representing this <code>NTime</code>'s value.
     * 
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof NTime))
            return false;
        NTime other = (NTime) obj;
        if (this.value == null) {
            if (other.value != null)
                return false;
    ...
    @Override
    public int compareTo(NTime other) {
        if (other == null) {
            return -1;
        }
        if (getValue() == null) {
    ...
    @Override
    public abstract NTime cloneObject();
     ...
     *            the cloned basetype
     */
    protected void cloneObject(NTime clone) {
        if (this.value != null) {
