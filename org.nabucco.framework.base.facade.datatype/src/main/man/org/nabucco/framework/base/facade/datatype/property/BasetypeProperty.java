 ...
 */
public final class BasetypeProperty<N extends Basetype> extends SingleProperty<N> implements
        NabuccoProperty<N> {
     ...
     */
    public BasetypeProperty(String name, Class<N> type, String constraints, N instance) {
        super(name, type, constraints, PropertyType.BASETYPE, instance);
    }
